...
void test_list_table(vector<size_t> sizes, auto data) {
    for (size_t N : sizes) {
        cout << "Testing insertion speed for ListHashTable with size = " << N << "\n";
        ...
        cout << "Testing search speed for ListHashTable with size = " << N << "\n";
        start = high_resolution_clock::now();
        ...
        cout << "Testing erase speed for ListHashTable with size = " << N << "\n";
        start = high_resolution_clock::now();
        for (const auto& key : search_keys) {
            list_table.search(key);
        }
